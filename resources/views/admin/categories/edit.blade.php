<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Kategori: {{ $category->name }}</h2>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <img src="{{ $category->icon_url }}" alt="Icon" class="h-16 w-16">
                        </div>
                        @endif

                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Ganti Icon (Optional)</label>
                            <input type="file" name="icon" accept="image/*" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
                        </div>
